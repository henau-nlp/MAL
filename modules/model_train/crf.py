...
class CRF(nn.Module):
    ...
    def __init__(self, in_features: int, tag_to_ix: dict):
        """
        ...
        self.transitions.data[:, self.pad_idx] = IMPOSSIBLE
        self.transitions.data[self.pad_idx, :] = IMPOSSIBLE
        self.transitions.data[self.pad_idx, self.stop_idx] = 0
    ...
    def __viterbi_decode(self, features, masks) -> tuple:
